    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">University Application</h1>
          <p className="text-gray-600">Fill out the form below to apply to {universityFromUrl || 'your chosen university'}</p>
        </div>
